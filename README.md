...
> **Reproducibility principle:** the report's numerical results and
> figures should be regenerated from the preserved project evidence
> rather than manually recreated from reported values.
